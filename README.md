...
| --- | --- | --- | --- | --- | --- |
| FIVES | A high-resolution fundus vessel segmentation dataset with quality labels and diverse disease background. | Segmentation \| Vessel Segmentation, Multi Disease Background | 2022 | [Figshare DOI](https://doi.org/10.6084/m9.figshare.19688169.v1) | [Open](resources/fives.md) |
...
| PAPILA | A glaucoma-focused fundus dataset with bilateral eye relationships and paired clinical information. | Classification, Segmentation \| Glaucoma | 2021 | [Figshare](https://figshare.com/articles/dataset/PAPILA/14798004) | [Open](resources/papila.md) |
...
| Dataset | Snapshot | Best for | Year | Official | Profile |
| --- | --- | --- | --- | --- | --- |
| Open Ultrawidefield Fundus Dataset | A dedicated ultrawidefield entry kept separate from standard fundus datasets because the image geometry and distribution shift matter. | Classification, Quality Assessment \| Multi Disease | 2024 | [Figshare DOI](https://doi.org/10.6084/m9.figshare.26936446) | [Open](resources/open_uwf_fundus.md) |
...
| Dataset | Snapshot | Best for | Year | Official | Profile |
| --- | --- | --- | --- | --- | --- |
| GRAPE | A longitudinal multimodal glaucoma dataset that combines fundus images, visual fields, OCT measurements, and follow-up structure. | Progression, Segmentation \| Glaucoma | 2023 | [Springer Nature Figshare](https://springernature.figshare.com/collections/GRAPE_A_multi-modal_glaucoma_dataset_of_follow-up_visual_field_and_fundus_images_for_glaucoma_management/6406319) | [Open](resources/grape.md) |
...
| MMRDR | A recent multimodal diabetic retinopathy benchmark spanning CFP, OCT, and UWF imaging. | Classification \| Diabetic Retinopathy | 2025 | [Figshare](https://figshare.com/articles/dataset/MMRDR/29423747) | [Open](resources/mmrdr.md) |
